  ...
  <div class="home">
    <div class="page-wrapper">
      <div class="header-wrapper">
        <div class="logo">
          <img src="../assets/img/Logo.svg" alt="pineapple">
          <span>pineapple</span>
        </div>
        <nav class="main-menu">
          <div class="main-menu__item">About</div>
          <div class="main-menu__item">How it works</div>
          <div class="main-menu__item">Contact</div>
        </nav>
      </div>
      <div class="content-wrapper">
        <div>Subscribe to newsletter</div>
        <p>Subscribe to our newletter and get a 10% discount on pineapple glasses</p>
      </div>
      ...
      <div class="terms-of-use">
        <div class="checkbox-wrapper" @click="onAgreeToTerms">
          ...
          <div v-show="agreeToTerms" class="checkbox-check" >
            <img src="../assets/img/ic_checkmark.svg">
          </div>
        </div>
        <span class="terms-text">I agree to</span>
      ...
      <div class="social-wrapper">
        <div class="icons-wraper">
          <div class="facebook-wrapper" :class="{'facebook-wrapper-click': fb}" @click="onSocial('fb')">
            <svg width="8" height="16" viewBox="0 0 8 16" fill="#000" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="instagram-wrapper" :class="{'instagram-wrapper-click': inst}" @click="onSocial('inst')">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="#6A707B" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="twitter-wrapper" :class="{'twitter-wrapper-click': tw}" @click="onSocial('tw')">
            <svg width="16" height="13" viewBox="0 0 16 13" fill="#6A707B" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="youtube-wrapper" :class="{'youtube-wrapper-click': yout}" @click="onSocial('yout')">
            <svg width="16" height="11" viewBox="0 0 16 11" fill="#6A707B" xmlns="http://www.w3.org/2000/svg">
...
.instagram-wrapper-click {
  background-color: #8F2762;
  svg {
    fill: #FFF;
  }
}
.twitter-wrapper-click {
  background-color: #177FBF;
  svg {
    fill: #FFF;
  }
}
.youtube-wrapper-click {
...
// .facebook-wrapper:hover svg {
//   fill: $grey;
// }
// .instagram-wrapper:hover svg {
//   fill: $grey;
// }
// .twitter-wrapper:hover svg {
//   fill: $grey;
// }
...
@media screen and (max-width: 1024px) {
  ...
  .page-wrapper {
    width: 100vw;
    background-image: url('../assets/img/sommer.png');
    background-repeat: no-repeat;
    background-position: center;
